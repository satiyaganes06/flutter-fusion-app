              ...
              children: [
                ...
                ...List.generate(
                  ...
                  (index) => TableRow(children: [
                    ...
                    Text(
                      "RM ${controller.ordersDetailsData![index].itemsprice}",
                      textAlign: TextAlign.center,
                    )
                  ]),
                )
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("RM ${controller.ordersModel!.ordersPricedelivery}",
                    style: TextStyle(
                        fontSize: 16,
                        color: myServices.sharedPreferences
                                    .getBool("isDarkMode") ==
                ...
                Text("Before coupon = ",
                    style: TextStyle(
                        ...
                        color: myServices.sharedPreferences
                            ...
                            ? const Color.fromARGB(255, 214, 211, 214)
                            : const Color.fromARGB(255, 58, 57, 58))),
                Text("RM ${controller.ordersModel!.ordersPrice}",
                    style: TextStyle(
                        fontSize: 16,
                        color: myServices.sharedPreferences
                                    .getBool("isDarkMode") ==
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("RM ${controller.ordersModel!.ordersTotalprice}",
